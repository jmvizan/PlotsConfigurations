...
opt.CME = '13.6'
opt.lumi = 41.48 if 'Summer22EE' in opt.tag else 41.48
treePrefix= ''
...
bTagWorkingPoints = { 'DeepJetL'     : { 'discriminant' : 'DeepFlavourBDisc' , 'cut' : '0.0532' },  
                      'DeepJetM'     : { 'discriminant' : 'DeepFlavourBDisc' , 'cut' : '0.3040' },
                      'DeepJetT'     : { 'discriminant' : 'DeepFlavourBDisc' , 'cut' : '0.7476' },
                      'ParticleNetL' : { 'discriminant' : 'PNetBDisc'        , 'cut' : '0.0532' },
                      'ParticleNetM' : { 'discriminant' : 'PNetBDisc'        , 'cut' : '0.3040' },
                      'ParticleNetT' : { 'discriminant' : 'PNetBDisc'        , 'cut' : '0.7476' },
                      'ParTL'        : { 'discriminant' : 'ParTBDisc'        , 'cut' : '0.0532' },
                      'ParTM'        : { 'discriminant' : 'ParTBDisc'        , 'cut' : '0.3040' },
                      'ParTT'        : { 'discriminant' : 'ParTBDisc'        , 'cut' : '0.7476' },
                     }
...
if 'SM' in opt.sigset or 'MC' in opt.sigset:
    ...
    if 'WorkingPoints' in opt.tag:
        ...
        samples['QCD'] = { 'name'     : getSampleFiles(directoryBkg+'QCD_PT-80to120_TuneCP5_13p6TeV_pythia8/','QCD_PT-80to120_TuneCP5_13p6TeV_pythia8',True,treePrefix,skipTreesCheck) ,
                           'weight'   : '1.' ,
                           'isSignal' : 0 ,

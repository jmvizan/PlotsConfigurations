...
public:
  ...
  ~BTagEntry() {}
  static std::string makeNewCSVHeader();
  std::string makeNewCSVLine() const;
  ...
  std::string getWP(OperatingPoint op) const;
...
public:
  ...
  void makeNewCSV(std::ostream &s) const;
  std::string makeNewCSV() const;

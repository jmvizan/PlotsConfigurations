...
if 'nonpromptSF' in opt.tag: # To check that mismodelling doesnt change much the limits
    ...
    elif '2017'       in yeartag: nonpromptLep = { 'rate' : '1.00', 'rateUp' : '1.38', 'rateDown' : '0.61' } 
...
if 'BackSF' in opt.tag:
    ...
    if '2016' in yeartag:
            ...
            normBackgrounds['ttZ'] = {"tz1": {"exclusiveSelection": 1, "selection": "(ptmiss"+ctrltag+">=160 && ptmiss"+ctrltag+"<220)", "scalefactor": {"0.408873874828": "0.713813423581"}, "cuts": ["ttZ"]}, "tz3": {"exclusiveSelection": 1, "selection": "(ptmiss"+ctrltag+">=280 && ptmiss"+ctrltag+"<380)", "scalefactor": {"2.14353899042": "2.54558982305"}, "cuts": ["ttZ"]}, "tz2": {"exclusiveSelection": 1, "selection": "(ptmiss"+ctrltag+">=220 && ptmiss"+ctrltag+"<280)", "scalefactor": {"1.18656410358": "1.48495154662"}, "cuts": ["ttZ"]}, "tz4": {"exclusiveSelection": 1, "selection": "(ptmiss"+ctrltag+">=380)", "scalefactor": {"-0.439607147131": "3.50561191569"}, "cuts": ["ttZ"]}}
        ...
        normBackgrounds['ttZ'] = {'tz1': {'exclusiveSelection': 1, 'selection': '(ptmiss'+ctrltag+'>=160 && ptmiss'+ctrltag+'<220)', 'scalefactor': {'2.06936282752': '0.99981236776'}, 'cuts': ['ttZ']}, 'tz3': {'exclusiveSelection': 1, 'selection': '(ptmiss'+ctrltag+'>=280 && ptmiss'+ctrltag+'<380)', 'scalefactor': {'3.45013411751': '2.43919481175'}, 'cuts': ['ttZ']}, 'tz2': {'exclusiveSelection': 1, 'selection': '(ptmiss'+ctrltag+'>=220 && ptmiss'+ctrltag+'<280)', 'scalefactor': {'1.01109357226': '1.31867043189'}, 'cuts': ['ttZ']}, 'tz4': {'exclusiveSelection': 1, 'selection': '(ptmiss'+ctrltag+'>=380)', 'scalefactor': {'-0.656876764451': '3.29220677094'}, 'cuts': ['ttZ']}}
        if 'WZtoWW' in opt.tag:
            normBackgrounds['WZ'] = {'ww10': {'exclusiveSelection': 0, 'selection': '(ptmiss'+ctrltag+'>=160 && ptmiss'+ctrltag+'<220)', 'scalefactor': {'1.17690004895': '0.14537978304'}, 'cuts': ['WZtoWW_Zcut10']}, 'ww15': {'exclusiveSelection': 0, 'selection': '(ptmiss'+ctrltag+'>=160 && ptmiss'+ctrltag+'<220)', 'scalefactor': {'1.1675866243': '0.14460455135'}, 'cuts': ['WZtoWW_Zcut15']}, 'ww40': {'exclusiveSelection': 0, 'selection': '(ptmiss'+ctrltag+'>=380)', 'scalefactor': {'0.800542118995': '0.27241140959'}, 'cuts': ['WZtoWW_Zcut10']}, 'ww45': {'exclusiveSelection': 0, 'selection': '(ptmiss'+ctrltag+'>=380)', 'scalefactor': {'0.79840719637': '0.265900274356'}, 'cuts': ['WZtoWW_Zcut15']}, 'ww20': {'exclusiveSelection': 0, 'selection': '(ptmiss'+ctrltag+'>=220 && ptmiss'+ctrltag+'<280)', 'scalefactor': {'1.00607496615': '0.185183533197'}, 'cuts': ['WZtoWW_Zcut10']}, 'ww30': {'exclusiveSelection': 0, 'selection': '(ptmiss'+ctrltag+'>=280 && ptmiss'+ctrltag+'<380)', 'scalefactor': {'0.99315061994': '0.216951732983'}, 'cuts': ['WZtoWW_Zcut10']}, 'ww25': {'exclusiveSelection': 0, 'selection': '(ptmiss'+ctrltag+'>=220 && ptmiss'+ctrltag+'<280)', 'scalefactor': {'0.963933885678': '0.179130910294'}, 'cuts': ['WZtoWW_Zcut15']}, 'ww35': {'exclusiveSelection': 0, 'selection': '(ptmiss'+ctrltag+'>=280 && ptmiss'+ctrltag+'<380)', 'scalefactor': {'0.982138899004': '0.212427943972'}, 'cuts': ['WZtoWW_Zcut15']}}

        elif 'ZLeps' in opt.tag:
            normBackgrounds['WZ'] = {'wz2k': {'exclusiveSelection': 0, 'selection': '(ptmiss'+ctrltag+'>=220 && ptmiss'+ctrltag+'<280)', 'scalefactor': {'1.11653995821': '0.224988581691'}, 'cuts': ['WZ_3LepZ']}, 'wz4z': {'exclusiveSelection': 0, 'selection': '(ptmiss'+ctrltag+'>=380)', 'scalefactor': {'0.919960698372': '0.357438466305'}, 'cuts': ['WZ_3Lep_']}, 'wz1k': {'exclusiveSelection': 0, 'selection': '(ptmiss'+ctrltag+'>=160 && ptmiss'+ctrltag+'<220)', 'scalefactor': {'1.19876396952': '0.154411092308'}, 'cuts': ['WZ_3LepZ']}, 'wz2z': {'exclusiveSelection': 0, 'selection': '(ptmiss'+ctrltag+'>=220 && ptmiss'+ctrltag+'<280)', 'scalefactor': {'1.19147680511': '0.226185047232'}, 'cuts': ['WZ_3Lep_']}, 'wz4k': {'exclusiveSelection': 0, 'selection': '(ptmiss'+ctrltag+'>=380)', 'scalefactor': {'0.693675128524': '0.334854252953'}, 'cuts': ['WZ_3LepZ']}, 'wz3z': {'exclusiveSelection': 0, 'selection': '(ptmiss'+ctrltag+'>=280 && ptmiss'+ctrltag+'<380)', 'scalefactor': {'0.996210684043': '0.279380044076'}, 'cuts': ['WZ_3Lep_']}, 'wz1z': {'exclusiveSelection': 0, 'selection': '(ptmiss'+ctrltag+'>=160 && ptmiss'+ctrltag+'<220)', 'scalefactor': {'1.20453726658': '0.151068869155'}, 'cuts': ['WZ_3Lep_']}, 'wz3k': {'exclusiveSelection': 0, 'selection': '(ptmiss'+ctrltag+'>=280 && ptmiss'+ctrltag+'<380)', 'scalefactor': {'0.892351114595': '0.275618605903'}, 'cuts': ['WZ_3LepZ']}}

        else:
            normBackgrounds['WZ'] = {'wz4': {'exclusiveSelection': 0, 'selection': '(ptmiss'+ctrltag+'>=380)', 'scalefactor': {'0.870147418171': '0.338742315821'}, 'cuts': ['_NoJet', '_Veto', '_NoTag', '_Tag', 'WZ_3Lep_']}, 'wz2': {'exclusiveSelection': 0, 'selection': '(ptmiss'+ctrltag+'>=220 && ptmiss'+ctrltag+'<280)', 'scalefactor': {'1.27252675991': '0.230422103256'}, 'cuts': ['_NoJet', '_Veto', '_NoTag', '_Tag', 'WZ_3Lep_']}, 'wz3': {'exclusiveSelection': 0, 'selection': '(ptmiss'+ctrltag+'>=280 && ptmiss'+ctrltag+'<380)', 'scalefactor': {'1.07704184317': '0.281645258727'}, 'cuts': ['_NoJet', '_Veto', '_NoTag', '_Tag', 'WZ_3Lep_']}, 'wz4p': {'exclusiveSelection': 0, 'selection': '(ptmiss'+ctrltag+'>=380)', 'scalefactor': {'0.675966989496': '0.326534695174'}, 'cuts': ['WZ_3LepZ']}, 'wz1p': {'exclusiveSelection': 0, 'selection': '(ptmiss'+ctrltag+'>=160 && ptmiss'+ctrltag+'<220)', 'scalefactor': {'1.16679337122': '0.150225352981'}, 'cuts': ['WZ_3LepZ']}, 'wz2p': {'exclusiveSelection': 0, 'selection': '(ptmiss'+ctrltag+'>=220 && ptmiss'+ctrltag+'<280)', 'scalefactor': {'1.15476083418': '0.226911689634'}, 'cuts': ['WZ_3LepZ']}, 'wz1': {'exclusiveSelection': 0, 'selection': '(ptmiss'+ctrltag+'>=160 && ptmiss'+ctrltag+'<220)', 'scalefactor': {'1.21507642583': '0.148909109934'}, 'cuts': ['_NoJet', '_Veto', '_NoTag', '_Tag', 'WZ_3Lep_']}, 'wz3p': {'exclusiveSelection': 0, 'selection': '(ptmiss'+ctrltag+'>=280 && ptmiss'+ctrltag+'<380)', 'scalefactor': {'0.920886803324': '0.275123154977'}, 'cuts': ['WZ_3LepZ']}}


    elif '2018' in yeartag:
        normBackgrounds['ZZTo2L2Nu'] = {'zz4': {'exclusiveSelection': 1, 'selection': '(ptmiss'+ctrltag+'>=380)', 'scalefactor': {'1.10844678741': '0.685951015408'}, 'cuts': ['_NoJet', '_Veto', '_NoTag', '_Tag', 'ZZ']}, 'zz3': {'exclusiveSelection': 1, 'selection': '(ptmiss'+ctrltag+'>=280 && ptmiss'+ctrltag+'<380)', 'scalefactor': {'0.74889885311': '0.395056981858'}, 'cuts': ['_NoJet', '_Veto', '_NoTag', '_Tag', 'ZZ']}, 'zz2': {'exclusiveSelection': 1, 'selection': '(ptmiss'+ctrltag+'>=220 && ptmiss'+ctrltag+'<280)', 'scalefactor': {'0.708573946655': '0.280518903975'}, 'cuts': ['_NoJet', '_Veto', '_NoTag', '_Tag', 'ZZ']}, 'zz1': {'exclusiveSelection': 1, 'selection': '(ptmiss'+ctrltag+'>=160 && ptmiss'+ctrltag+'<220)', 'scalefactor': {'0.938738860471': '0.183091667585'}, 'cuts': ['_NoJet', '_Veto', '_NoTag', '_Tag', 'ZZ']}}
        normBackgrounds['ZZTo4L'] = {'zz4': {'exclusiveSelection': 1, 'selection': '(ptmiss'+ctrltag+'>=380)', 'scalefactor': {'1.10844678741': '0.685951015408'}, 'cuts': ['_NoJet', '_Veto', '_NoTag', '_Tag', 'ZZ']}, 'zz3': {'exclusiveSelection': 1, 'selection': '(ptmiss'+ctrltag+'>=280 && ptmiss'+ctrltag+'<380)', 'scalefactor': {'0.74889885311': '0.395056981858'}, 'cuts': ['_NoJet', '_Veto', '_NoTag', '_Tag', 'ZZ']}, 'zz2': {'exclusiveSelection': 1, 'selection': '(ptmiss'+ctrltag+'>=220 && ptmiss'+ctrltag+'<280)', 'scalefactor': {'0.708573946655': '0.280518903975'}, 'cuts': ['_NoJet', '_Veto', '_NoTag', '_Tag', 'ZZ']}, 'zz1': {'exclusiveSelection': 1, 'selection': '(ptmiss'+ctrltag+'>=160 && ptmiss'+ctrltag+'<220)', 'scalefactor': {'0.938738860471': '0.183091667585'}, 'cuts': ['_NoJet', '_Veto', '_NoTag', '_Tag', 'ZZ']}}
        normBackgrounds['ttZ'] = {'tz1': {'exclusiveSelection': 1, 'selection': '(ptmiss'+ctrltag+'>=160 && ptmiss'+ctrltag+'<220)', 'scalefactor': {'0.783056223534': '0.603517905136'}, 'cuts': ['ttZ']}, 'tz3': {'exclusiveSelection': 1, 'selection': '(ptmiss'+ctrltag+'>=280 && ptmiss'+ctrltag+'<380)', 'scalefactor': {'1.20146825329': '1.52032391843'}, 'cuts': ['ttZ']}, 'tz2': {'exclusiveSelection': 1, 'selection': '(ptmiss'+ctrltag+'>=220 && ptmiss'+ctrltag+'<280)', 'scalefactor': {'1.02860595864': '1.00821891795'}, 'cuts': ['ttZ']}, 'tz4': {'exclusiveSelection': 1, 'selection': '(ptmiss'+ctrltag+'>=380)', 'scalefactor': {'-0.634153905734': '2.23065249957'}, 'cuts': ['ttZ']}}

        if 'WZtoWW' in opt.tag:
            normBackgrounds['WZ'] = {'ww10': {'exclusiveSelection': 0, 'selection': '(ptmiss'+ctrltag+'>=160 && ptmiss'+ctrltag+'<220)', 'scalefactor': {'1.03805545918': '0.123572589853'}, 'cuts': ['WZtoWW_Zcut10']}, 'ww15': {'exclusiveSelection': 0, 'selection': '(ptmiss'+ctrltag+'>=160 && ptmiss'+ctrltag+'<220)', 'scalefactor': {'1.04982528726': '0.124882884595'}, 'cuts': ['WZtoWW_Zcut15']}, 'ww40': {'exclusiveSelection': 0, 'selection': '(ptmiss'+ctrltag+'>=380)', 'scalefactor': {'0.54368403857': '0.204764883769'}, 'cuts': ['WZtoWW_Zcut10']}, 'ww45': {'exclusiveSelection': 0, 'selection': '(ptmiss'+ctrltag+'>=380)', 'scalefactor': {'0.601772045017': '0.209305536497'}, 'cuts': ['WZtoWW_Zcut15']}, 'ww20': {'exclusiveSelection': 0, 'selection': '(ptmiss'+ctrltag+'>=220 && ptmiss'+ctrltag+'<280)', 'scalefactor': {'0.722912407741': '0.138432782057'}, 'cuts': ['WZtoWW_Zcut10']}, 'ww30': {'exclusiveSelection': 0, 'selection': '(ptmiss'+ctrltag+'>=280 && ptmiss'+ctrltag+'<380)', 'scalefactor': {'0.766527926749': '0.168236736031'}, 'cuts': ['WZtoWW_Zcut10']}, 'ww25': {'exclusiveSelection': 0, 'selection': '(ptmiss'+ctrltag+'>=220 && ptmiss'+ctrltag+'<280)', 'scalefactor': {'0.716792262416': '0.136490646408'}, 'cuts': ['WZtoWW_Zcut15']}, 'ww35': {'exclusiveSelection': 0, 'selection': '(ptmiss'+ctrltag+'>=280 && ptmiss'+ctrltag+'<380)', 'scalefactor': {'0.812708612869': '0.170208534936'}, 'cuts': ['WZtoWW_Zcut15']}}

        elif 'ZLeps' in opt.tag:
            normBackgrounds['WZ'] = {'wz2k': {'exclusiveSelection': 0, 'selection': '(ptmiss'+ctrltag+'>=220 && ptmiss'+ctrltag+'<280)', 'scalefactor': {'0.590644576651': '0.141370875227'}, 'cuts': ['WZ_3LepZ']}, 'wz4z': {'exclusiveSelection': 0, 'selection': '(ptmiss'+ctrltag+'>=380)', 'scalefactor': {'0.797343258876': '0.289849564356'}, 'cuts': ['WZ_3Lep_']}, 'wz1k': {'exclusiveSelection': 0, 'selection': '(ptmiss'+ctrltag+'>=160 && ptmiss'+ctrltag+'<220)', 'scalefactor': {'1.0023381486': '0.1183536315'}, 'cuts': ['WZ_3LepZ']}, 'wz2z': {'exclusiveSelection': 0, 'selection': '(ptmiss'+ctrltag+'>=220 && ptmiss'+ctrltag+'<280)', 'scalefactor': {'0.673364807326': '0.148237720699'}, 'cuts': ['WZ_3Lep_']}, 'wz4k': {'exclusiveSelection': 0, 'selection': '(ptmiss'+ctrltag+'>=380)', 'scalefactor': {'0.620625510939': '0.269982134989'}, 'cuts': ['WZ_3LepZ']}, 'wz3z': {'exclusiveSelection': 0, 'selection': '(ptmiss'+ctrltag+'>=280 && ptmiss'+ctrltag+'<380)', 'scalefactor': {'0.629108052071': '0.183489696318'}, 'cuts': ['WZ_3Lep_']}, 'wz1z': {'exclusiveSelection': 0, 'selection': '(ptmiss'+ctrltag+'>=160 && ptmiss'+ctrltag+'<220)', 'scalefactor': {'0.999553813105': '0.1190522737'}, 'cuts': ['WZ_3Lep_']}, 'wz3k': {'exclusiveSelection': 0, 'selection': '(ptmiss'+ctrltag+'>=280 && ptmiss'+ctrltag+'<380)', 'scalefactor': {'0.592833245722': '0.185340042261'}, 'cuts': ['WZ_3LepZ']}}

        else:
            normBackgrounds['WZ'] = {'wz4': {'exclusiveSelection': 0, 'selection': '(ptmiss'+ctrltag+'>=380)', 'scalefactor': {'0.823567320601': '0.287684272571'}, 'cuts': ['_NoJet', '_Veto', '_NoTag', '_Tag', 'WZ_3Lep_']}, 'wz2': {'exclusiveSelection': 0, 'selection': '(ptmiss'+ctrltag+'>=220 && ptmiss'+ctrltag+'<280)', 'scalefactor': {'0.701975881604': '0.147741586834'}, 'cuts': ['_NoJet', '_Veto', '_NoTag', '_Tag', 'WZ_3Lep_']}, 'wz3': {'exclusiveSelection': 0, 'selection': '(ptmiss'+ctrltag+'>=280 && ptmiss'+ctrltag+'<380)', 'scalefactor': {'0.712367780623': '0.189577508989'}, 'cuts': ['_NoJet', '_Veto', '_NoTag', '_Tag', 'WZ_3Lep_']}, 'wz4p': {'exclusiveSelection': 0, 'selection': '(ptmiss'+ctrltag+'>=380)', 'scalefactor': {'0.611611140618': '0.26623698791'}, 'cuts': ['WZ_3LepZ']}, 'wz1p': {'exclusiveSelection': 0, 'selection': '(ptmiss'+ctrltag+'>=160 && ptmiss'+ctrltag+'<220)', 'scalefactor': {'0.989069761499': '0.116295103327'}, 'cuts': ['WZ_3LepZ']}, 'wz2p': {'exclusiveSelection': 0, 'selection': '(ptmiss'+ctrltag+'>=220 && ptmiss'+ctrltag+'<280)', 'scalefactor': {'0.58935564084': '0.138949735664'}, 'cuts': ['WZ_3LepZ']}, 'wz1': {'exclusiveSelection': 0, 'selection': '(ptmiss'+ctrltag+'>=160 && ptmiss'+ctrltag+'<220)', 'scalefactor': {'1.0096092582': '0.11871432717'}, 'cuts': ['_NoJet', '_Veto', '_NoTag', '_Tag', 'WZ_3Lep_']}, 'wz3p': {'exclusiveSelection': 0, 'selection': '(ptmiss'+ctrltag+'>=280 && ptmiss'+ctrltag+'<380)', 'scalefactor': {'0.575494942407': '0.181345240793'}, 'cuts': ['WZ_3LepZ']}}

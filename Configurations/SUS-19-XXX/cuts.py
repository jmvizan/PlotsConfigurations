...
if 'StopSignalRegions' in opt.tag:
    if 'Data' in opt.sigset:
        ...
        if 'pt30' in opt.tag:
            btagcut=BTAG30
            vetocut=VETO30
        cuts['SR1_Tag_em']   = OC+' && '+DF+' && ptmiss>=140 && ptmiss<200 && '+isrcut+btagcut
        cuts['SR1_Veto_em']  = OC+' && '+DF+' && ptmiss>=140 && ptmiss<200 && '+isrcut+vetocut
    
        cuts['SR1_Tag_sf']   = OC+' && '+SF+' && ptmiss>=140 && ptmiss<200 && '+isrcut+btagcut
        cuts['SR1_Veto_sf']  = OC+' && '+SF+' && ptmiss>=140 && ptmiss<200 && '+isrcut+vetocut
    
        cuts['SR2_Tag_em']   = OC+' && '+DF+' && ptmiss>=200 && ptmiss<300 && '+isrcut+btagcut
        cuts['SR2_Veto_em']  = OC+' && '+DF+' && ptmiss>=200 && ptmiss<300 && '+isrcut+vetocut
    
        cuts['SR2_Tag_sf']   = OC+' && '+SF+' && ptmiss>=200 && ptmiss<300 && '+isrcut+btagcut
        cuts['SR2_Veto_sf']  = OC+' && '+SF+' && ptmiss>=200 && ptmiss<300 && '+isrcut+vetocut
        ...
        cuts['SR1_Tag_em']   = '(' + OC+' && '+DF+' && ptmiss>=140 && ptmiss<200'+isrcut+btagcut+')*btagWeight_1tag'
        cuts['SR1_Veto_em']  = '(' + OC+' && '+DF+' && ptmiss>=140 && ptmiss<200'+isrcut+vetocut+')*(1.-btagWeight_1tag)'

        cuts['SR1_Tag_sf']   = '(' + OC+' && '+SF+' && ptmiss>=140 && ptmiss<200'+isrcut+btagcut+')*btagWeight_1tag'
        cuts['SR1_Veto_sf']  = '(' + OC+' && '+SF+' && ptmiss>=140 && ptmiss<200'+isrcut+vetocut+')*(1.-btagWeight_1tag)'

        cuts['SR2_Tag_em']   = '(' + OC+' && '+DF+' && ptmiss>=200 && ptmiss<300'+isrcut+btagcut+')*btagWeight_1tag'
        cuts['SR2_Veto_em']  = '(' + OC+' && '+DF+' && ptmiss>=200 && ptmiss<300'+isrcut+vetocut+')*(1.-btagWeight_1tag)'

        cuts['SR2_Tag_sf']   = '(' + OC+' && '+SF+' && ptmiss>=200 && ptmiss<300'+isrcut+btagcut+')*btagWeight_1tag'
        cuts['SR2_Veto_sf']  = '(' + OC+' && '+SF+' && ptmiss>=200 && ptmiss<300'+isrcut+vetocut+')*(1.-btagWeight_1tag)'
